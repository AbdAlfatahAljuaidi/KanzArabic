...
const videos = [
  ...
  { id: 7, src: "https://res.cloudinary.com/danvxvhvq/video/upload/v1762276278/ttt_asapyz.mp4", title: "Video 7" },
];
  ...
  return (
    <section id="videos" className="py-32 px-6 bg-gray-50">
      <div className="text-center mb-8">
        <h2 className="text-4xl font-bold mb-2 text-customRed">فيديوهاتنا</h2>
        <p className="text-gray-600 text-center">استمتع بمشاهدة افكارنا</p>
      </div>
